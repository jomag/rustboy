...
|       |       |       |       |       |       |       |       |       |       |       |       |       |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| cgb_sound | [:red_circle:](x "01-registers: FAIL") | [:red_circle:](x "02-len ctr: FAIL") | [:red_circle:](x "03-trigger: FAIL") | [:green_heart:](x "04-sweep: PASS") | [:green_heart:](x "05-sweep details: PASS") | [:green_heart:](x "06-overflow on trigger: PASS") | [:green_heart:](x "07-len sweep period sync: PASS") | [:red_circle:](x "08-len ctr during power: FAIL") | [:red_circle:](x "09-wave read while on: FAIL") | [:green_heart:](x "10-wave trigger while on: PASS") | [:red_circle:](x "11-regs after power: FAIL") | [:red_circle:](x "12-wave: FAIL") |
...
| dmg_sound | [:red_circle:](x "01-registers: FAIL") | [:red_circle:](x "02-len ctr: FAIL") | [:red_circle:](x "03-trigger: FAIL") | [:green_heart:](x "04-sweep: PASS") | [:green_heart:](x "05-sweep details: PASS") | [:green_heart:](x "06-overflow on trigger: PASS") | [:green_heart:](x "07-len sweep period sync: PASS") | [:red_circle:](x "08-len ctr during power: FAIL") | [:red_circle:](x "09-wave read while on: FAIL") | [:red_circle:](x "10-wave trigger while on: FAIL") | [:red_circle:](x "11-regs after power: FAIL") | [:red_circle:](x "12-wave write while on: FAIL") |
